<?php
/*
Template Name: Buy essay online
*/


get_header(); ?>

        <div class="main-banner col-xs-12 col-sm-12" id="main-banner" style="background-image: url('<?php echo get_theme_mod('buy_image', get_bloginfo('template_url').'/img/layer-2.jpg'); ?> ');">
			<div class="container">
			    <div class="main-wrapper-banenr clearfix">
                    <div class="left-wrapepr col-xs-12 col-sm-8">
                        <h1><?php echo get_theme_mod('buy_my_heading', 'BEST EXPERT LOREM TEXT'); ?></h1>
                        <div class="main-banner__description">
                            <?php echo get_theme_mod('buy_my_text', 'Lorem ipsum'); ?>
                        </div>
                    </div>
